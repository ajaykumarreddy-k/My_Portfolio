...
export function TextFlippingBoardSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full bg-[#E8E8E8] flex flex-col items-center justify-center overflow-hidden pb-24 pt-8">
      <div className="w-full max-w-[1400px] px-4 md:px-8 text-center mb-12">
        <span className="text-sm md:text-base font-black uppercase tracking-[0.25em] text-black font-sans">
          Quick Thoughts
        </span>
      </div>
