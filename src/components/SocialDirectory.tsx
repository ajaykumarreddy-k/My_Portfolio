...
export default function SocialDirectory() {
  return (
    <section className="relative w-full bg-[#E8E8E8] flex flex-col items-center justify-center overflow-hidden border-t border-black/5 dark:border-white/5 pb-4">
      ...
      <div className="w-full overflow-x-auto overflow-y-hidden hide-scrollbar bg-[#E8E8E8]">
        <div className="min-w-[800px] w-full max-w-[1400px] mx-auto">
          <div className="poster-canvas">
            {/* Card 1: Email */}
            <a href="mailto:ajaykumarreddykrishnareddygari@gmail.com" className="card card-1 group hover:scale-[1.03] transition-transform duration-300">
              <h2>EMAIL</h2>
              <p>CONNECT</p>
            ...
            {/* Card 2: GitHub */}
            <a href="https://github.com/ajaykumarreddy-k" target="_blank" rel="noopener noreferrer" className="card card-2 group hover:scale-[1.03] transition-transform duration-300">
            ...
            <div className="card card-3 pointer-events-none">
            ...
            <div className="card card-4 blue-card-content pointer-events-none">
            ...
            {/* Card 5: LinkedIn */}
            <a href="https://www.linkedin.com/in/ajay-kumar-reddy-krishnareddy-gari-a4885b282/" target="_blank" rel="noopener noreferrer" className="card card-5 group hover:scale-[1.03] transition-transform duration-300">
              <h2>LINKEDIN</h2>
              <p>NETWORK</p>
            ...
            {/* Card 6: Resume */}
            <a href="/Resume/KRISHNAREDDY GARI AJAY KUMAR REDDY_Doc.pdf" target="_blank" rel="noopener noreferrer" className="card card-6 group hover:scale-[1.03] transition-transform duration-300">
              <div className="card-image-container">
