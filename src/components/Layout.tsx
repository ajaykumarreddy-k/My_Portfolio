 ...
 * Maintains consistency with the Home page background, navigation, and Lenis smooth scroll.
 */
          ...
          <div className="hidden md:flex items-center gap-8">
            {[
              ...
              <button
                ...
                className={`text-sm transition-colors cursor-pointer ${currentPath === item.path
